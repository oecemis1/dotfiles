-- Shared highlight mapping for the colors/*.lua flavors: each colorscheme
-- file supplies a palette, the role assignments live here once.
-- Normal/statusline/gutter backgrounds stay NONE so the terminal
-- transparency shows through (same trick as helix themes/current.toml).
local M = {}
...
function M.apply(name, colors)
  ...
  highlight("Normal", { fg = colors.foreground, bg = "NONE" })
  highlight("NormalNC", { fg = colors.foreground, bg = "NONE" })
  ...
  highlight("LineNr", { fg = colors.comment, bg = "NONE" })
  highlight("SignColumn", { fg = colors.comment, bg = "NONE" })
  highlight("FoldColumn", { fg = colors.comment, bg = "NONE" })
  ...
  highlight("VertSplit", { fg = colors.comment, bg = "NONE" })
  highlight("WinSeparator", { fg = colors.comment, bg = "NONE" })
  ...
  highlight("StatusLine", { fg = colors.foreground, bg = "NONE", bold = true })
  highlight("StatusLineNC", { fg = colors.comment, bg = "NONE" })
  ...
  highlight("WinBar", { fg = colors.foreground, bg = "NONE" })
  highlight("WinBarNC", { fg = colors.comment, bg = "NONE" })
