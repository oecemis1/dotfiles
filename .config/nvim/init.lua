...
-- lua/current-theme.lua is generated by color-scheme.nix from
-- colorScheme.flavor; flavor names match the files under colors/.
local theme_ok, theme = pcall(require, "current-theme")
vim.cmd.colorscheme(theme_ok and theme or "dracula")
